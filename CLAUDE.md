...
`BUYWISE_MOBILE_GUIDE.md` holds the rules every mobile change follows, and `DESIGN.md` is the UX/UI reference for the web frontend.
...
As of 2026-09-24, `docs/API.md`, `docs/ARCHITECTURE.md`, `docs/DATABASE.md`, `docs/DESIGN_DECISIONS.md`, and the root `README.md` still describe accounts and transfers, which no longer exist in the code. Where they disagree with the code and this file, the code wins. Updating them is pending; delete this paragraph once it is done.
